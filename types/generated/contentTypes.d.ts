...
export interface ApiBodBod extends Schema.CollectionType {
  collectionName: 'bods';
  info: {
    singularName: 'bod';
    pluralName: 'bods';
  ...
  attributes: {
    Post: Attribute.String & Attribute.Required;
    Role: Attribute.String & Attribute.Required;
    Name: Attribute.String;
    Category: Attribute.Enumeration<
      ['Committee of Administration\t', 'Board of Directors']
    > &
      Attribute.Required;
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::bod.bod', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::bod.bod', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}

export interface ApiBusinessUnitBusinessUnit extends Schema.CollectionType {
  ...
  attributes: {
    Title: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::business-unit.business-unit', 'Title'> &
      Attribute.Required;
    WelfareUnit: Attribute.Enumeration<
      [
    ...
    Partners: Attribute.Component<'partner-section.layout'>;
    Services: Attribute.Component<'services-section.service'>;
    SupportTitle: Attribute.String & Attribute.Required;
    SupportDescription: Attribute.Text & Attribute.Required;
    CardImage: Attribute.Media<'images'> & Attribute.Required;
...
export interface ApiMdMessageMdMessage extends Schema.SingleType {
  collectionName: 'md_messages';
  info: {
    singularName: 'md-message';
    pluralName: 'md-messages';
    displayName: 'MdMessage';
    description: '';
  };
  options: {
    draftAndPublish: true;
